...
class_prefix_str = "Ihew"
# class_prefix_str = "IUEO"


# nosearch_directorys = ["Pods", "Pseudo_3DTests", "Pseudo_3DUITests", "ZipfdsdfdArchive"]
# nosearch_directorys = ["Pods","Model","3DESiOS","AppDelegate"]
# "ExXX","3DESiOS","YoIaKWIQQTzhEMD",
nosearch_directorys = ["Pods","Model","Heagthodkal","XiaoMieRagDlTests","XiaoMieRagDlUITests"]
# nosearch_directorys = ["Pods","Model","ExXX","3DESiOS","ChuanSJ","ThyweGuilde","Heagthodkal","XiaoMieRagDlTests","XiaoMieRagDlUITests","YoIaKBENLPqClahYmpf","YoIaKHJIHjHAKRSC","YoIaKPDAZBzet","fmdb","YoIaKMBXlsdDK","YoIaKLGCaiBgUfVdOOtjh","YoIaKTHKPnYyNqepv"]
...
def get_insert_0919_handle_class_obj(use_insert_class_list, insert_0905_type):
    class_name = "YoIaKThjzxjghjweesrgklhse"
    for insert_class_obj in use_insert_class_list:
        if class_name in insert_class_obj.class_name:
            return insert_class_obj
    return None
...
def get_insert_0912_handle_class_obj(use_insert_class_list, insert_0905_type):
    class_name = ""
    if insert_0905_type == global_0905insert_type_longlong:
        class_name = "BillieJeanIsNotMyLoverH1aILongan"
    elif insert_0905_type == global_0905insert_type_NSString:
        class_name = "BillieJeanIsNotMyLoveringStrHaan"
    elif insert_0905_type == global_0905insert_type_double:
        class_name = "BillieJeanIsNotMyLoverDo222BHan"
    elif insert_0905_type == global_0905insert_type_NSArray:
        class_name = "BillieJeanIsNotMyLoverayAYRRHn"
    for insert_class_obj in use_insert_class_list:
        if insert_class_obj.class_name == class_name:
            return insert_class_obj
    return None
...
def reduction_0919_prototype_from_type(prototype_list, insert_0919_type):
    ...
    if insert_0919_type == global_0905insert_type_double:
        method_transfer_name = "YoIaKThjzxjghjweesrgklhseD22ubLRE"       
    elif insert_0919_type == global_0905insert_type_longlong:
        method_transfer_name = "YoIaKThjzxjghjweesrgklhseLHongRE"
    elif insert_0919_type == global_0905insert_type_NSString:
        method_transfer_name = "YoIaKThjzxjghjweesrgklhseRNstigE"
    elif insert_0919_type == global_0905insert_type_NSArray:
        method_transfer_name = "YoIaKThjzxjghjweesrgklhseRErRay"
...
def handle_0919_prototype_from_type(prototype_list, insert_0919_type):
    method_transfer_name = ""
    if insert_0919_type == global_0905insert_type_double:
        method_transfer_name = "YoIaKThjzxjghjweesrgklhseD22ubLHan"    
    elif insert_0919_type == global_0905insert_type_longlong:
        method_transfer_name = "YoIaKThjzxjghjweesrgklhseLHongAN"
    elif insert_0919_type == global_0905insert_type_NSString:
        method_transfer_name = "YoIaKThjzxjghjweesrgklhseHNstigAn"
    elif insert_0919_type == global_0905insert_type_NSArray:
        method_transfer_name = "YoIaKThjzxjghjweesrgklhserRayHan"
    for prototype_obj in prototype_list:
        if method_transfer_name in prototype_obj.transfer_name:
            return prototype_obj
    return None
