...
class_prefix_str = "LDUO"

nosearch_directorys = ["Pods", "Pseudo_3DTests", "Pseudo_3DUITests", "ZipfdsdfdArchive","MiundRuralVC","MiundComprehensiveBearView","MiundJournalistFictionView","GreatJoyGraspTests","GreatJoyGraspUITests","DesFile","ExXX","3DESiOS","DifferentBtn","GKKCover","XDPagesresView"]
...
def reduction_0919_prototype_from_type(prototype_list, insert_0919_type):
    ...
    if insert_0919_type == global_0905insert_type_NSString:
        method_transfer_name = "GaiThatIWananNotREGTRSrNG0"
    elif insert_0919_type == global_0905insert_type_NSArray:
        method_transfer_name = "GaiThatIWananNotRAwryaARRE0"
    elif insert_0919_type == global_0905insert_type_longlong:
        method_transfer_name = "GaiThatIWananNotLionREL0N"
    elif insert_0919_type == global_0905insert_type_double:
        method_transfer_name = "GaiThatIWananNotREDuoleb0"
...
def handle_0919_prototype_from_type(prototype_list, insert_0919_type):
    method_transfer_name = ""
    if insert_0919_type == global_0905insert_type_NSString:
        method_transfer_name = "GaiThatIWananNotHAGTRSrNGN"
    elif insert_0919_type == global_0905insert_type_NSArray:
        method_transfer_name = "GaiThatIWananNotRE0HARrrNAdren"
    elif insert_0919_type == global_0905insert_type_longlong:
        method_transfer_name = "GaiThatIWananNotLionHaL0N"
    elif insert_0919_type == global_0905insert_type_double:
        method_transfer_name = "GaiThatIWananNotHADuolebN"
    for prototype_obj in prototype_list:
        if method_transfer_name in prototype_obj.transfer_name:
            return prototype_obj
    return None
